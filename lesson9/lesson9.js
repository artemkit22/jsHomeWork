...
// // document.body.appendChild(div1); ВАЛИТЬ ПОМИЛКУ!!!!!!!!!!!!!!!
// console.log(copy)
...
//     {         name: 'Lisa',
//         surname: 'Simpson',         age: 9,
//         info: 'Ли́за Мари́ Си́мпсон (англ. Lisa Marie Simpson) — героиня мультипликационного сериала «Симпсоны». Средний ребёнок в семье, восьмилетняя девочка, выделяющаяся среди остальных Симпсонов прежде всего своим умом и рассудительностью.',
//         photo: 'https://upload.wikimedia.org/wikipedia/ru/e/ec/Lisa_Simpson.png'
//     },
//      {
//         name: 'Maggie',         surname: 'Simpson',
//         age: 1,         info: 'Ма́ргарет Эвелин «Мэ́гги» Си́мпсон (англ. Margaret Evelyn “Maggie” Simpson) — персонаж мультсериала «Симпсоны». Впервые появилась на телевидении в шоу Трейси Ульман, в короткометражке Good Night (англ.)русск. 19 апреля 1987 года. Мэгги была придумана и разработана карикатуристом Мэттом Грейнингом, пока он ждал встречи с Джеймсом Л. Бруксом. Названа в честь младшей сестры Грейнинга. После появления в шоу Трейси Ульман, через три года семья Симпсонов получила собственный сериал на телеканале Fox, дебют произошёл 17 декабря 1989 года.',
...
//     h3.innerText = `Name is: ${item.name}! Surname is: ${item.surname}!`
//     p.innerText = `Age: ${item.age}!
//     Info who is it: ${item.info}!`
//     img.src = `${item.photo}`
//
//     div.append(h3,p,img)
// document.body.appendChild(div)
...
for (const item of coursesArray) {
   let div= document.createElement('div');
    div.innerText = `${item.title} ${item.monthDuration} ${item.hourDuration} ${item.modules}`
   ...
   let div1=document.createElement('div')
        div1.innerText = `${itemdiv.modules}`
    document.body.append(div1)

    }
//
   //      // for (const mode of itemdiv) {
   //      //     div1item.modules
   //      // }
